  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div 
        ...
        className="relative w-full max-w-lg bg-card rounded-2xl shadow-2xl animate-in zoom-in-95 fade-in duration-200"
      >
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="p-6 pb-4 text-center border-b border-border">
          ...
          <h2 id="new-project-title" className="text-xl font-display font-bold text-foreground">
            New Project
          </h2>
