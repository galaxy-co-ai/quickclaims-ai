        ...
        <div className="flex items-center justify-between h-[56px] px-2">
          ...
          <div className="flex items-center pr-2">
            ...
            <SignedOut>
              <Link
                href="/sign-in"
                className="flex flex-col items-center justify-center w-14 h-12 rounded-lg text-muted-foreground hover:text-foreground transition-colors"
              >
                <div className="w-7 h-7 rounded-full flex items-center justify-center mb-0.5 bg-muted">
